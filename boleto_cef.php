...
$dadosboleto["nosso_numero"] = strlen($nosso_numero) > 8 ? substr($nosso_numero,0,8) : str_pad($nosso_numero,8,'0', STR_PAD_LEFT);  // Nosso numero sem o DV - REGRA: Máximo de 8 caracteres!
